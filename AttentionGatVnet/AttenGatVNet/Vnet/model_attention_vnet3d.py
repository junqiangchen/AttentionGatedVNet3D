...
def _create_attention_conv_net(X, image_z, image_width, image_height, image_channel, phase, drop, n_class=1):
...
class AttenGatVnet3dModule(object):
    """
    ...
    def __init__(self, image_height, image_width, image_depth, channels=1, costname=("dice coefficient",),
        ...
        self.Y_pred = _create_attention_conv_net(self.X, self.image_depth, self.image_width, self.image_height,
